...
savefigureddc <- "simulationrank3out31mac1outDDCcelloutlier"
...
savefigure <- "mac1simulationrank3out31casym"
...
savefigureddc <- "simulationrank3out31mac2outDDCcelloutlier"
...
savefigure <- "mac2simulationrank3out31casym"
...
# length(MacroPCA.out$DDC$indcells)
# 
# savefigureddc <- "simulationrank3out31mac3outDDCcelloutlier"
# 
# pdf(paste0("add plots/f2/", savefigureddc, ".pdf"), width = 12,
#     height = 12)
# ggpmacropca     <- cellMap(R = MacroPCA.out$DDC$stdResid,                        
...
# yaxis <- 2
# 
# savefigure <- "mac3simulationrank3out31casym"
# 
# 
# if(Flip == "flip x"){
#   rowproj[,xaxis] <- -rowproj[,xaxis]
