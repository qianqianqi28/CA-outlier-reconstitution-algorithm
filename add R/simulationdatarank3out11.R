...
savefigure <- "simulationrank3rawcasym"
...
round(X.svd$d, 3)
round((X.svd$d^2)/sum(X.svd$d^2), 3)
...
savefigure <- "simulationrank3out11casym"
pdf(file = paste0("add plots/f2/",savefigure,".pdf"), width = 12,
    height = 12)
par(mar = c(5, 6, 4, 2) + 0.1)  # Bottom, left, top, right
par(mgp = c(4, 1.8, 0))
...
savefigure <- "simulationrank3out11rec0casym"
pdf(file = paste0("add plots/f2/",savefigure,".pdf"), width = 12,
    height = 12)
par(mar = c(5, 6, 4, 2) + 0.1)  # Bottom, left, top, right
par(mgp = c(4, 1.8, 0))
...
savefigure <- "simulationrank3out11rec1casym"
pdf(file = paste0("add plots/f2/",savefigure,".pdf"), width = 12,
    height = 12)
par(mar = c(5, 6, 4, 2) + 0.1)  # Bottom, left, top, right
par(mgp = c(4, 1.8, 0))
...
recval <- reconca(dt, ncp = 3, initials = 1, threshold = 1e-15, outliercell = outliercell, maxiter = 100000, verbose=TRUE)
